...
for a in pwca_catalog:
    ...
    opt_nu4,opt_nu5,opt_nu6,opt_zeta2 = dphi_range[k,:]
    ...
    opt_model_dphi = template_dphi( raw_fp, opt_nu4, opt_nu5, opt_nu6, opt_zeta2 )
    ...
    #
    plot( raw_f, raw_amp_td, label='Symmetrised NR (TD)', color='k', alpha=0.5 )
    #
