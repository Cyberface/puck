...
for a in A:
    ...
    savetxt( txt_file_path, data_array, header='[ f, fd_amp, fd_dphi ], frequencies are positive, waveform info are symmetrized from NR simulation at %s'%frame['raw'].simdir )
